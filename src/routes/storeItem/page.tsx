...
function StoreItems(props) {
  ...
  const {bringBucket, removeBucket }=useBucketlist();
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", padding: "20px", overflowY: "auto", paddingBottom: "70px"}}>
      <h4 style={{ fontWeight: "bold", textAlign: "center", marginBottom:"10%", color:"gray"}}>위시 동영상 저장</h4>
      
      <div style={{ flex: 1}}>
        <Button variant="info" style={{borderRadius:"10px", fontSize:"25px",width:"50px", height:"50px", fontWeight:"600", color:"white", marginRight:"15px", marginLeft:"10px",backgroundColor:"#B6A6F6", borderColor:"#B6A6F6"}}
        onClick={handleShow}>+</Button>
        <span style={{fontSize:"17px", color:"darkgray"}} >새 양동이 추가</span>
      </div>
        ...
        {buckets.length > 0 ? (
          buckets.map((bucket, index) => (
            ...
            borderBottom: "0.5px solid #E9E4FF" }}>
              ...
              <svg  onClick={() => handleRemoveBucket(bucket._id)}xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
