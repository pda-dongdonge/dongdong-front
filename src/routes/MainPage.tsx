...
<h1 className="fade-text rounded-text" style={{ fontWeight: "bold", color: "black", height: "100px", opacity: 0 }}>DongdongE에 오신 걸 환영합니다!</h1>
  ...
  <section className="block">
    <div className="item-parallax-content flex-container img-grid">
      ...
      <div  className="scroll-image" style={ {borderRadius: "15px",
        ...
        <div className="img-caption" >
          <h1 >Youtube</h1>
          <p className="scroll-image" style={{color:"#5610A7", fontWeight:"bold"}}>
      ...
      <div className="scroll-image" style={ {borderRadius: "15px",
        ...
        {/* <img src="https://cdn.digitaltoday.co.kr/news/photo/201910/216206_191039_2844.jpg" alt="Tving" /> */}
  ...
  <section className="block">
    <div className="item-parallax-content flex-container img-grid">
      ...
      <div className="scroll-image" style={ {borderRadius: "15px",
        ...
        {/* <img src="https://www.kocca.kr/trend/vol30/img/s11/img_1.jpg" alt="neflix" /> */}
      ...
      <figure className="img-gridItem type-left" style={{display:"flex", gap:"20px", justifyContent:"center"}}>
        {/* <img src="https://img.wavve.com/service30/profile/wavve.png" alt="wavve" /> */}
        <figcaption className="img-caption">
