    ...
    <>
      <main className="content js-content">
        <section className="block" style={{ textAlign: "center", marginBottom: "150px", marginTop: "100px" }}>
          <h1 className="fade-text rounded-text" style={{ fontWeight: "bold", color: "black", height: "100px", opacity: 0 }}>
            DongdongE에 오신 걸 환영합니다!
          </h1>
          ...
          <div className="item-parallax-content flex-container img-grid">
            <figure className="img-gridItem type-right" style={{ display: "flex", gap: "20px", justifyContent: "center" }}>
              ...
              <div className="img-caption">
                <h1>Youtube</h1>
                <p className="scroll-image" style={{ color: "#5610A7", fontWeight: "bold" }}>자신의 취향대로,</p>
              </div>
            </figure>
            <figure className="img-gridItem type-left" style={{ display: "flex", gap: "20px", justifyContent: "center" }}>
              <div className="img-caption">
                <h2 className="head-small">TVING</h2>
                <p className="scroll-image" style={{ color: "#5610A7", fontWeight: "bold" }}>다양한 OTT의 영상을,</p>
              </div>
              <div className="scroll-image" style={{
                borderRadius: "15px",
          ...
          <div className="item-parallax-content flex-container img-grid">
            <figure className="img-gridItem type-right" style={{ display: "flex", gap: "20px", justifyContent: "center" }}>
              ...
              <figcaption className="img-caption">
                <h2>Neflix</h2>
                <p className="scroll-image" style={{ color: "#5610A7", fontWeight: "bold" }}>양동이에 저장하고 공유하는,</p>
              </figcaption>
            </figure>
            <figure className="img-gridItem type-left" style={{ display: "flex", gap: "20px", justifyContent: "center" }}>
              <figcaption className="img-caption">
                <h2 className="scroll-image">Wavve</h2>
                <p className="scroll-image" style={{ color: "#5610A7", fontWeight: "bold" }}>서비스 동동이입니다!</p>
              </figcaption>
              <div className="scroll-image" style={{
                borderRadius: "15px",
        ...
        <section className="block section-end" style={{ textAlign: "center", marginBottom: "50px" }}>
          <h1 className="head-large">
            <div style={{ cursor: "pointer", fontWeight: "bold" }} onClick={() => {
              navigate('/hot');
            }}>저희랑 함께 하실래요? | JOIN</div>
          </h1>
        </section>
      </main>
    </>
